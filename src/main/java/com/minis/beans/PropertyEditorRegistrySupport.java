...
public class PropertyEditorRegistrySupport {
    ...
    public PropertyEditorRegistrySupport() throws Exception {
        registerDefaultEditors();
    }

    protected void registerDefaultEditors() throws Exception {
    ...
    private void createDefaultEditors() throws Exception {
